-- RussElite Imperial Hub - gui.lua
...
local function createImperialFlag(parent, size)
    ...
    crown.Size = UDim2.new(0.6, 0, 0.5, 0)
    crown.Position = UDim2.new(0.2, 0, 0.25, 0)
    crown.BackgroundTransparency = 1
    crown.Text = "👑"
    crown.TextSize = size and size * 0.5 or 14
...
function Gui:CreateToggle()
    ...
    btn.MouseEnter:Connect(function()
        createTween(btn, {BackgroundTransparency = 0.1}, 0.2):Play()
        createTween(glowRing, {Transparency = 0.3}, 0.2):Play()
    end)
    
    btn.MouseLeave:Connect(function()
        createTween(btn, {BackgroundTransparency = CONFIG.GlassTransparency}, 0.2):Play()
        createTween(glowRing, {Transparency = 0.6}, 0.2):Play()
    end)
...
function Gui:CreateWindow()
    ...
    closeBtn.MouseEnter:Connect(function()
        createTween(closeBtn, {BackgroundTransparency = 0.2}, 0.2):Play()
    end)
    closeBtn.MouseLeave:Connect(function()
        createTween(closeBtn, {BackgroundTransparency = 0.5}, 0.2):Play()
    end)
    
    -- Search bar
    local searchFrame = Instance.new("Frame")
    searchFrame.Size = UDim2.new(0.96, 0, 0, 32)
    searchFrame.Position = UDim2.new(0.02, 0, 0, 58)
    searchFrame.BackgroundColor3 = COLORS.GlassBg
    searchFrame.BackgroundTransparency = 0.5
    searchFrame.ZIndex = 22
    searchFrame.Parent = window
    
    applyGlass(searchFrame, 10)
    ...
    searchBox.Text = ""
    searchBox.TextColor3 = COLORS.ImperialWhite
    ...
    contentArea.Position = UDim2.new(0.02, 0, 0, 98)
    ...
    backBtn.MouseEnter:Connect(function()
        createTween(backBtn, {BackgroundTransparency = 0.2}, 0.2):Play()
    end)
    backBtn.MouseLeave:Connect(function()
        createTween(backBtn, {BackgroundTransparency = 0.5}, 0.2):Play()
    end)
    ...
    coroutine.wrap(function()
        while statusDot and statusDot.Parent do
            ...
            task.wait(0.8)
            createTween(statusDot, {BackgroundTransparency = 0.7}, 0.8):Play()
            task.wait(0.8)
        end
    end)()
...
function Gui:OnCategoryClick(categoryName)
    ...
    if type(result) == "table" then
        ...
        self.Elements.StatusText.Text = "Loaded: " .. categoryName
        self.Elements.StatusText.TextColor3 = COLORS.Success
    else
...
function Gui:LoadDatabase()
    ...
    if ok and result then
        ...
        self.Elements.StatusText.Text = "Imperial Hub Ready!"
        self.Elements.StatusText.TextColor3 = COLORS.Success
        task.wait(2)
        self.Elements.StatusText.Text = "Ready"
        self.Elements.StatusText.TextColor3 = COLORS.ImperialWhite
    else
        self.Elements.StatusText.Text = "Database error!"
        self.Elements.StatusText.TextColor3 = COLORS.Error
    end
end
