...
function Library.CreateStroke(parent, thickness, color, transparency)
...
function Library.CreateTween(obj, tweenInfo, goal)
return TweenService:Create(obj, tweenInfo, goal)
end

function Library.SafeHttpGet(url)
